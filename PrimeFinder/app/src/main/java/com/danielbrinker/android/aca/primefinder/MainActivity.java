...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrimesToList = (TextView) findViewById(R.id.primesToList);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                long prime = Long.parseLong(mEditText.getText().toString());
                mPrimefinder = new PrimeFinder(PrimesToList);

            }
        });

        //mPrimeFinder = new PrimeFinder(22);
    }
